...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <!-- hapus none beserta ?? jika ingin login menggunakan user sesuai database atau jika ingin mengakses data pegawai -->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="#">alignleft</a>.</strong>
    All rights reserved.
